...
use Illuminate\Foundation\Console\ListenerMakeCommand as ListenerArtisanCommand;
use Symfony\Component\Console\Input\InputOption;

class ListenerMakeCommand extends ListenerArtisanCommand
{
    /**
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return "{$rootNamespace}\\Shared\\Listeners";
    }
