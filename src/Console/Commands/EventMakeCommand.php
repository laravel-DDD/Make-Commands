...
use Illuminate\Foundation\Console\EventMakeCommand as EventArtisanCommand;
 ...
 */
class EventMakeCommand extends EventArtisanCommand
{
    /**
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return "{$rootNamespace}\\Shared\\Events";
    }
